...
function CardOrden({nombre, telefono, cuit, modelo, serie, fecha, detalle, observaciones, numero, estado, empresa, contacto, localidad, direccion, provincia,trabajoRealizado, costo, idEmpresa}) {
  ...
  const imprimirSegmento = () => {
    ...
    html2pdf()
      ...
      .save()
      .then(() => {
        console.log('El segmento se ha guardado como PDF');
      })
      .catch((error) => {
        console.error('Error al guardar el segmento como PDF:', error);
      });
  };
